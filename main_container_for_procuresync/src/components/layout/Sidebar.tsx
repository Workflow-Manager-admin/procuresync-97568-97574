...
const navigation: NavItem[] = [
  ...
  { title: "Purchase Requests", path: "/requests", icon: "requests" },
  { title: "Approvals", path: "/approvals", icon: "approvals" },
  { title: "Suppliers", path: "/suppliers", icon: "suppliers" },
  { title: "Order Tracking", path: "/orders", icon: "orders" },
  { title: "Stock Management", path: "/stock", icon: "stock" },
...
function NavLink({ item }: { item: NavItem }) {
  ...
  const isActive = currentModule === item.path.slice(1) || (item.path === "/" && currentModule === "dashboard");
      ...
      <div className="p-4">
        <div className="py-4">
          <div className="flex items-center mb-6">
            ...
            <h2 className="ml-2 text-xl font-bold text-gray-900 dark:text-white">ProcureSync</h2>
          </div>
